...
public interface Constants {
  ...
  // CPU Voltage
    ...
    // AiO Hotplug
    String AIO_HOTPLUG = "/sys/kernel/AiO_HotPlug";
    String AIO_HOTPLUG_ENABLE = AIO_HOTPLUG + "/toggle";
    String AIO_HOTPLUG_ONLINE = AIO_HOTPLUG + "/cores";
    String AIO_HOTPLUG_BIG = AIO_HOTPLUG + "/big_cores";
    String AIO_HOTPLUG_LITTLE = AIO_HOTPLUG + "/LITTLE_cores";
    
    
    
    String[][] CPU_HOTPLUG_ARRAY = {{HOTPLUG_MPDEC, MSM_SLEEPER, STATE_HELPER, MSMPERFORMANCE, BCH, HIMA_HOTPLUG, AIO_HOTPLUG}, INTELLIPLUG_ARRAY, BLU_PLUG_ARRAY, HOTPLUG_MSM_ARRAY, MAKO_HOTPLUG_ARRAY,
